...
public class FileTests {
    ...
    public void testCheck() throws IOException {
        ...
        // 目录
        assertTrue(Files.exists(Paths.get(AbstractIO.BATH_PATH + "file"))); // true 文件存在；false 不存在或不确定是否存在
        // 文件
        assertTrue(Files.exists(Paths.get(AbstractIO.BATH_PATH + "file/test")));
        // 文件
        assertTrue(Files.notExists(Paths.get(AbstractIO.BATH_PATH + "file/test1"))); // true 文件不存在；false 存在或不确定是否存在


        // 读、写、可执行属性
        // 文件
        Path pf = Paths.get(AbstractIO.BATH_PATH + "file/test");
        ...
        // 目录
        Path pd = Paths.get(AbstractIO.BATH_PATH + "file");
        ...
        // ln -s 创建软连接
        Path p1 = Paths.get(AbstractIO.BATH_PATH + "file/t"); // link
        Path p2 = Paths.get(AbstractIO.BATH_PATH + "file/test"); // actual file
        assertTrue(Files.isSameFile(p1, p2));
    }

    @Test(expected = IOException.class)
    public void testDeleteHaveException() throws IOException {
        Path p = Paths.get(AbstractIO.BATH_PATH + "file/test1");
    ...
    public void testCopy() throws IOException {
        // 文件
        Path sourceFile = Paths.get(AbstractIO.BATH_PATH + "file/test");
        Path targetFile = Paths.get(AbstractIO.BATH_PATH + "file/test1");

        // 目录
        Path sourceDir = Paths.get(AbstractIO.BATH_PATH + "file/dir");
        Path targetDir = Paths.get(AbstractIO.BATH_PATH + "file/dir1");
    ...
    public void testMetaData() throws IOException {
        Path file = Paths.get(AbstractIO.BATH_PATH + "file/test");
        Path directory = Paths.get(AbstractIO.BATH_PATH + "file/dir");
    ...
    public void testReadAndWriteFileByLine() throws IOException {
        Path readPath = Paths.get(AbstractIO.BATH_PATH + "file/test");
        Path writePath = Paths.get(AbstractIO.BATH_PATH + "file/test1");
    ...
    public void testListDirectoryContents() throws IOException {
        Path bathPath = Paths.get(AbstractIO.BATH_PATH + "file");
    ...
    public void testVisitFile() throws IOException {
        Path p = Paths.get(AbstractIO.BATH_PATH);

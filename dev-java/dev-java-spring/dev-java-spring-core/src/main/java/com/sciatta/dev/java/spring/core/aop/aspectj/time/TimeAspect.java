package com.sciatta.dev.java.spring.core.aop.aspectj.time;

import com.sciatta.dev.java.spring.core.aop.common.PrintUtils;
...
public class TimeAspect {
    @Around(value = "com.sciatta.dev.java.spring.core.aop.aspectj.CommonAspect.findUser(userName)", argNames = "pjp,userName")
    ...
    @Before(value = "com.sciatta.dev.java.spring.core.aop.aspectj.CommonAspect.findUser(userName)", argNames = "userName")
    ...
    @After(value = "com.sciatta.dev.java.spring.core.aop.aspectj.CommonAspect.findUser(userName)", argNames = "userName")
    ...
    @AfterReturning(pointcut = "com.sciatta.dev.java.spring.core.aop.aspectj.CommonAspect.findUser(userName)",
    ...
    @AfterThrowing(pointcut = "com.sciatta.dev.java.spring.core.aop.aspectj.CommonAspect.findUser(userName)",

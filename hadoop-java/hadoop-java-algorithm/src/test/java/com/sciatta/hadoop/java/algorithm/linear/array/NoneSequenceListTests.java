...
public class NoneSequenceListTests extends SequenceListTests {
    public void testInsert() {
        ...
        assertArrayEquals(formatArrayData(new Integer[]{1, 2, 8, 4}, MAXSIZE), sequenceList.datas);

        sequenceList.insert(10, 1);
        assertArrayEquals(formatArrayData(new Integer[]{1, 10, 8, 4, 2}, MAXSIZE), sequenceList.datas);

        sequenceList.insert(20, 5);
        assertArrayEquals(formatArrayData(new Integer[]{1, 10, 8, 4, 2, 20}, MAXSIZE), sequenceList.datas);

        sequenceList.insert(40, 1);
        assertArrayEquals(formatArrayData(new Integer[]{1, 40, 8, 4, 2, 20, 10}, MAXSIZE), sequenceList.datas);
    }
    ...
    public void testDelete() {
        ...
        assertArrayEquals(formatArrayData(new Integer[]{1, 2, 8, 4, 10, 20, 80, 40, 60, 70}, MAXSIZE), sequenceList.datas);
        assertEquals(10, sequenceList.count);   // 10/10

        sequenceList.delete(2);
        assertArrayEquals(formatArrayData(new Integer[]{1, 8, 4, 10, 20, 80, 40, 60, 70}, MAXSIZE), sequenceList.datas);
        ...
        assertArrayEquals(formatArrayData(new Integer[]{1, 8, 4}, MAXSIZE), sequenceList.datas);
        assertEquals(9, sequenceList.count);    // 有碎片  9/3

        sequenceList.insert(100);   // 触发insert碎片整理 4/4
        assertArrayEquals(formatArrayData(new Integer[]{1, 8, 4, 100}, MAXSIZE), sequenceList.datas);
        assertEquals(4, sequenceList.count);

        sequenceList.insert(99, 0);
        assertArrayEquals(formatArrayData(new Integer[]{99, 8, 4, 100, 1}, MAXSIZE), sequenceList.datas);

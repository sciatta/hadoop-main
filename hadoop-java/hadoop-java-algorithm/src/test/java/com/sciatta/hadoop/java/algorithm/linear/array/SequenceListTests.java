...
public class SequenceListTests {
    ...
    public void testInsert() {
        ...
        assertArrayEquals(formatArrayData(new Integer[]{10, 1, 2, 8, 4}, MAXSIZE), sequenceList.datas);

        sequenceList.insert(70, 3);
        assertArrayEquals(formatArrayData(new Integer[]{10, 1, 2, 70, 8, 4}, MAXSIZE), sequenceList.datas);

        sequenceList.insert(90, 6);
        assertArrayEquals(formatArrayData(new Integer[]{10, 1, 2, 70, 8, 4, 90}, MAXSIZE), sequenceList.datas);
    }
    ...
    public void testDelete() {
        ...
        assertArrayEquals(formatArrayData(new Integer[]{1, 2, 4}, MAXSIZE), sequenceList.datas);

        sequenceList.delete(1);
        assertArrayEquals(formatArrayData(new Integer[]{2, 4}, MAXSIZE), sequenceList.datas);
    }

...
public class HdfsToHBase extends Configured implements Tool {
    ...
    private void configHFileOutputFormat2(Job job) throws IOException {
        ...
        HFileOutputFormat2.configureIncrementalLoad(job, table, connection.getRegionLocator(TableName.valueOf(DEST_TABLE)));
    ...
    public static void main(String[] args) throws Exception {
        ...
        configuration.set(TMP_DIR_KEY, TMP_DIR_VALUE);
